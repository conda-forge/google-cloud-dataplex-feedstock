...
Once the `conda-forge` channel has been enabled, `google-cloud-dataplex` can be installed with:

```
conda install google-cloud-dataplex
```

It is possible to list all of the versions of `google-cloud-dataplex` available on your platform with:
